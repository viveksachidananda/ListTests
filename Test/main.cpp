...
namespace unittests
{
    ...
    void testPushBack()
    {
        ...
        try {
            ...
            cout << "Test pushBack passed!" << endl;
        }
        catch (exception &iExc) {
    ...
    void testFilter(){
        ...
        try {
            ...
            cout << "Test modFilter passed!" << endl;
        }
        catch (exception &iExc) {
    ...
    void testFoldLeft()
    {
        ...
        try {
            ...
            cout << "Test foldLeft passed!" << endl;
        }
        catch (exception &iExc) {
...
int main() {
    ...
    unittests::testPushBack();

    unittests::testPopBack();

    unittests::testSize();

    unittests::testReverse();

    unittests::testFilter();

    unittests::testMap();

    unittests::testFoldLeft();
}